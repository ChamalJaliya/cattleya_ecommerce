...
const CategoryTreeView: React.FC<CategoryTreeViewProps> = ({
  ...
  return (
    <div className="w-full">
      {/* Header */}
      <div className="flex items-center justify-between mb-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
        <div>
        ...
        <button
          ...
          className="flex items-center px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:shadow-lg transition-all duration-200"
        >
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        {rootCategories.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <button
              onClick={() => onAddCategory()}
              className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:shadow-lg transition-all duration-200"
            >
              <PlusIcon className="w-4 h-4 mr-2" />
      ...
      {selectedCategory && (
        ...
        >
          <h4 className="text-sm font-semibold text-blue-900 mb-2">Selected Category</h4>
