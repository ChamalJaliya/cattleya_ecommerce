    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-6">
        <div className="relative">
          ...
          <label className="absolute bottom-0 right-0 w-8 h-8 bg-white rounded-full shadow-md flex items-center justify-center hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <button 
            ...
            disabled={isLoading}
            className="bg-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-purple-700 transition-colors duration-200 disabled:opacity-50"
          >
                ...
                {isEditing ? (
                  <>
                    ...
                    <button
                      onClick={handleSave}
                      disabled={isLoading}
                      className="flex items-center px-4 py-2 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors duration-200 disabled:opacity-50"
                    >
