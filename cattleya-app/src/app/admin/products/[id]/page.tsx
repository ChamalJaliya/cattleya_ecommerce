        ...
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-8 relative z-10">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={handleEdit}
                  className="group relative overflow-hidden bg-gradient-to-r from-purple-600 to-violet-600 text-white px-8 py-4 rounded-2xl font-semibold hover:from-purple-700 hover:to-violet-700 transition-all duration-300 shadow-xl hover:shadow-purple-500/30"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="group relative">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600/15 via-violet-600/15 to-indigo-600/15 rounded-3xl blur opacity-40 group-hover:opacity-60 transition duration-300"></div>
                <div className="relative bg-white/90 backdrop-blur-md rounded-3xl shadow-xl border border-white/30 overflow-hidden hover:shadow-purple-500/10 transition-all duration-300">
                  {/* Main Image */}
